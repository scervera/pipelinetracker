...
class EngineersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engineer" do
    assert_difference('Engineer.count') do
      post engineers_url, params: { engineer: { carrier: @engineer.carrier, firstname: @engineer.firstname, lastname: @engineer.lastname } }
    end
  ...
  test "should update engineer" do
    patch engineer_url(@engineer), params: { engineer: { carrier: @engineer.carrier, firstname: @engineer.firstname, lastname: @engineer.lastname } }
