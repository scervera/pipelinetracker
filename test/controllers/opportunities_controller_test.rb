...
class OpportunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post opportunities_url, params: { opportunity: { customer_name: @opportunity.customer_name, quantity: @opportunity.quantity, stage: @opportunity.stage } }
    end
  ...
  test "should update opportunity" do
    patch opportunity_url(@opportunity), params: { opportunity: { customer_name: @opportunity.customer_name, quantity: @opportunity.quantity, stage: @opportunity.stage } }
